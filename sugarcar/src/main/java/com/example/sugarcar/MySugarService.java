...
public class MySugarService extends Service {
    public static final String READ_ACTION =
            "com.example.sugarcar.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "com.example.sugarcar.ACTION_MESSAGE_REPLY";
    public static final String CONVERSATION_ID = "conversation_id";
    public static final String EXTRA_VOICE_REPLY = "extra_voice_reply";
    private static final String TAG = MySugarService.class.getSimpleName();
    private final Messenger mMessenger = new Messenger(new IncomingHandler());
    private NotificationM2anagerCompat mNotificationManager;
